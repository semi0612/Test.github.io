...
function ImageFadeOut(qIdx, idx){
  ...
  one.disabled = true;
  one.classList.remove("fadeIn");
  one.classList.add("fadeOut");
  two.disabled = true;
  two.classList.remove("fadeIn");
  two.classList.add("fadeOut");
  three.disabled = true;
  three.classList.remove("fadeIn");
  three.classList.add("fadeOut");
  four.disabled = true;
  four.classList.remove("fadeIn");
  four.classList.add("fadeOut");
  five.disabled = true;
  five.classList.remove("fadeIn");
  five.classList.add("fadeOut");
